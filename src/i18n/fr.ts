export const fr = {
  meta: {
    home: {
      title: "Méridian - Développement de projets d'infrastructures",
      description:
    ...
    legal: {
      title: "Mentions légales - Méridian",
      description:
        "Informations relatives à l'édition, à l'hébergement et à la responsabilité du site de Méridian.",
    },
    privacy: {
      title: "Politique de confidentialité - Méridian",
      description:
        "Comment Méridian collecte, utilise et protège vos données personnelles.",
    },
    sitemap: {
      title: "Plan du site - Méridian",
      description:
        "Toutes les pages du site Méridian, réunies pour une navigation rapide.",
    },
  },
  nav: {
    home: "Accueil",
  ...
  common: {
    ...
    menu: "Menu",
    all: "Tous",
    notAvailable: "Information à venir",
    scrollToTop: "Retour en haut de page",
    placeholderNote:
      "L'écosystème complet des partenaires de Méridian est présenté sur la page Partenaires.",
  },
  hero: {
  ...
  stats: {
    ...
    items: [
      ...
      { value: "9", label: "Pays de présence" },
      { value: "3,2 Md€", label: "Investissements mobilisés" },
  ...
  ecosystem: {
    ...
    title: "Un écosystème de partenaires au service des projets",
    subtitle:
      "La réalisation de grands projets d'infrastructures repose sur la confiance et la collaboration de multiples acteurs.",
    categories: [
      {
        title: "Gouvernements & institutions publiques",
        body: "États, ministères et collectivités qui définissent les priorités stratégiques des territoires.",
      },
      {
        title: "Banques & institutions financières",
        body: "Institutions qui apportent les capacités de financement des projets structurants.",
      },
      {
        title: "Investisseurs",
        body: "Acteurs à la recherche d'opportunités d'investissement solides et durables.",
      },
      {
        title: "Partenaires techniques",
        body: "Bureaux d'études, ingénierie et entreprises spécialisées qui assurent la faisabilité et la réalisation.",
      },
      {
        title: "Entreprises spécialisées",
        body: "Opérateurs de construction et fournisseurs capables de réaliser des ouvrages complexes.",
      },
    ],
    placeholder: "Références présentées sur la page Partenaires.",
  },
  gallery: {
  ...
  sectorsPage: {
    ...
    ctaBody: "Présentez-nous votre projet. Notre équipe analysera son potentiel et les possibilités de structuration et de financement.",
  },
  projectsPage: {
    hero: {
      overline: "Projets",
  ...
  partnersPage: {
    ...
    categories: [
      {
        title: "Public",
        body: "Gouvernements, ministères, institutions publiques et collectivités.",
      },
      {
        title: "Finance",
        body: "Banques et institutions financières mobilisées pour le financement.",
      },
      {
        title: "Investissement",
        body: "Investisseurs et fonds recherchant des opportunités solides.",
      },
      {
        title: "Technique",
        body: "Bureaux d'études et ingénierie assurant la faisabilité.",
      },
      {
        title: "Ingénierie",
        body: "Experts techniques des ouvrages complexes.",
      },
      {
        title: "Construction",
        body: "Entreprises de réalisation et de mise en œuvre.",
      },
      {
        title: "Technologie",
        body: "Acteurs de la transformation numérique des infrastructures.",
      },
    ],
    slotTitle: "Intégration de logos",
    slotBody:
  ...
  contactPage: {
    ...
    form: {
      ...
      message: "Message",
      messagePh: "Décrivez votre demande ou votre projet",
  ...
  legalPage: {
    legal: {
      ...
      body: "Les informations relatives à l'édition, à l'hébergement et à la responsabilité du site.",
    },
    privacy: {
      overline: "Confidentialité",
      title: "Politique de confidentialité",
      body: "La manière dont nous collectons, utilisons et protégeons vos données personnelles.",
    },
  },
};
